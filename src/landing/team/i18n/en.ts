...
export const pageContent = {
    ...
    memoryWall: {
        ...
        memories: {
            m1: 'A small place for a big personality.',
            m2: 'Favorite nap, favorite sound, favorite tiny habit.',
            m3: 'A story that deserves its own warm corner.',
            m4: 'For every animal who made the house a team.'
        }
    },
    supportTransition: {
