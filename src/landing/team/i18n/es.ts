...
export const cardContent: LandingCardContent = {
    slug: 'equipo',
    seo: {
        title: 'El Equipo de GameBob Studio',
        description: 'Conoce a la junta felina, al desarrollador humano y la historia detrás de GameBob Studio, un proyecto independiente creado desde Mallorca.',
...
export const pageContent = {
    hero: {
        ...
        sceneAlt: 'Escena pixel art de Bob supervisando mientras JJ trabaja en un portátil'
    },
    companyWorks: {
    ...
    bobModelBook: {
        ...
        premiumText: 'Bob ha decidido que estas poses son demasiado potentes para un usuario casual. El acceso completo se abrirá cuando el modelo de negocio le parezca emocionalmente maduro.',
